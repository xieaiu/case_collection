...
VideoPlaybackQuality = v_saf(function VideoPlaybackQuality(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
...
EventCounts = v_saf(function EventCounts(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
...
Scheduler = v_saf(function Scheduler(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
// Keep Node's implementation when this browser shim is loaded by ExecJS.
var v_native_FinalizationRegistry = typeof FinalizationRegistry != 'undefined' ? FinalizationRegistry : undefined
FinalizationRegistry = v_native_FinalizationRegistry || v_saf(function FinalizationRegistry(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
...
MediaCapabilities = v_saf(function MediaCapabilities(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
...
VideoFrame = v_saf(function VideoFrame(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
...
CanvasGradient = v_saf(function CanvasGradient(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
...
MediaStream = v_saf(function MediaStream(){;}); _inherits(MediaStream, EventTarget)
MediaStreamTrack = v_saf(function MediaStreamTrack(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(MediaStreamTrack, EventTarget)
...
ErrorEvent = v_saf(function ErrorEvent(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(ErrorEvent, Event)
...
webkitMediaStream = v_saf(function webkitMediaStream(){;}); _inherits(webkitMediaStream, EventTarget)
...
MediaStreamTrackGenerator = v_saf(function MediaStreamTrackGenerator(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(MediaStreamTrackGenerator, MediaStreamTrack)
MediaStreamAudioDestinationNode = v_saf(function MediaStreamAudioDestinationNode(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(MediaStreamAudioDestinationNode, AudioNode)
...
AudioWorkletNode = v_saf(function AudioWorkletNode(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(AudioWorkletNode, AudioNode)
...
AnalyserNode = v_saf(function AnalyserNode(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(AnalyserNode, AudioNode)
...
Object.defineProperties(PerformanceEntry.prototype, {
  duration: {get(){ v_console_log("  [*] PerformanceEntry -> duration[get]", 0.10000002384185791);return 0.10000002384185791 }},
  name: {get(){ v_console_log("  [*] PerformanceEntry -> name[get]", "init_tea_duration");return "init_tea_duration" }},
  startTime: {get(){ v_console_log("  [*] PerformanceEntry -> startTime[get]", 9361);return 9361 }},
...
Object.defineProperties(Navigator.prototype, {
  userAgent: {get(){ v_console_log("  [*] Navigator -> userAgent[get]", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0");return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0" }},
  ...
  appVersion: {get(){ v_console_log("  [*] Navigator -> appVersion[get]", "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0");return "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0" }},
...
Object.defineProperties(Event.prototype, {
  ...
  type: {get(){ v_console_log("  [*] Event -> type[get]", "cat");return "cat" }},
  timeStamp: {get(){ v_console_log("  [*] Event -> timeStamp[get]", 7922.600000023842);return 7922.600000023842 }},
  stopImmediatePropagation: {value: v_saf(function stopImmediatePropagation(){v_console_log("  [*] Event -> stopImmediatePropagation[func]", [].slice.call(arguments));})},
...
Object.defineProperties(URLSearchParams.prototype, {
  ...
  append: {value: v_saf(function append(){v_console_log("  [*] URLSearchParams -> append[func]", [].slice.call(arguments));})},
  entries: {value: v_saf(function entries(){v_console_log("  [*] URLSearchParams -> entries[func]", [].slice.call(arguments));})},
...
Object.defineProperties(webkitURL.prototype, {
  ...
  pathname: {get(){ v_console_log("  [*] webkitURL -> pathname[get]", "/6096197105");return "/6096197105" },set(){ v_console_log("  [*] webkitURL -> pathname[set]", [].slice.call(arguments));return "/6096197105" }},
  href: {get(){ v_console_log("  [*] webkitURL -> href[get]", "https://mcs.zijieapi.com/list?aid=6383&sdk_version=5.1.24_dy");return "https://mcs.zijieapi.com/list?aid=6383&sdk_version=5.1.24_dy" }},
  username: {get(){ v_console_log("  [*] webkitURL -> username[get]", "a");return "a" }},
  host: {get(){ v_console_log("  [*] webkitURL -> host[get]", "mcs.zijieapi.com");return "mcs.zijieapi.com" }},
  hash: {get(){ v_console_log("  [*] webkitURL -> hash[get]", "#%D0%B1");return "#%D0%B1" }},
  hostname: {get(){ v_console_log("  [*] webkitURL -> hostname[get]", "lynxview");return "lynxview" },set(){ v_console_log("  [*] webkitURL -> hostname[set]", [].slice.call(arguments));return "lynxview" }},
  protocol: {get(){ v_console_log("  [*] webkitURL -> protocol[get]", "sslocal:");return "sslocal:" },set(){ v_console_log("  [*] webkitURL -> protocol[set]", [].slice.call(arguments));return "sslocal:" }},
  origin: {get(){ v_console_log("  [*] webkitURL -> origin[get]", "https://lf-dy-gr-sourcecdn.bytegecko.com");return "https://lf-dy-gr-sourcecdn.bytegecko.com" }},
  search: {get(){ v_console_log("  [*] webkitURL -> search[get]", "?recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1");return "?recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1" },set(){ v_console_log("  [*] webkitURL -> search[set]", [].slice.call(arguments));return "?recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1&recommend=1" }},
...
Object.defineProperties(Response.prototype, {
  ...
  url: {get(){ v_console_log("  [*] Response -> url[get]", "https://pull-flv-f26.douyinliving.com/thirdgame/stream-696506921172861761_hiqld5.flv?expire=6aa8b12a&sign=199ea36da89263aad6ab53a4d12c71df&exp_hrchy=s1&s_anchor=1&arch_hrchy=s2&major_anchor_level=vip&unique_id=stream-696506921172861761_833_flv_hiqld5&t_id=037-2026090810445709B1C4A5E3344A592B19-eoj957&biz_quality=ld&biz_protocol=flv");return "https://pull-flv-f26.douyinliving.com/thirdgame/stream-696506921172861761_hiqld5.flv?expire=6aa8b12a&sign=199ea36da89263aad6ab53a4d12c71df&exp_hrchy=s1&s_anchor=1&arch_hrchy=s2&major_anchor_level=vip&unique_id=stream-696506921172861761_833_flv_hiqld5&t_id=037-2026090810445709B1C4A5E3344A592B19-eoj957&biz_quality=ld&biz_protocol=flv" }},
...
Object.defineProperties(Headers.prototype, {
  entries: {value: v_saf(function entries(){v_console_log("  [*] Headers -> entries[func]", [].slice.call(arguments));})},
...
Object.defineProperties(TimeRanges.prototype, {
  length: {get(){ v_console_log("  [*] TimeRanges -> length[get]", 0);return 0 }},
...
Object.defineProperties(VideoPlaybackQuality.prototype, {
  droppedVideoFrames: {get(){ v_console_log("  [*] VideoPlaybackQuality -> droppedVideoFrames[get]", 0);return 0 }},
  totalVideoFrames: {get(){ v_console_log("  [*] VideoPlaybackQuality -> totalVideoFrames[get]", 63);return 63 }},
  corruptedVideoFrames: {get(){ v_console_log("  [*] VideoPlaybackQuality -> corruptedVideoFrames[get]", 0);return 0 }},
...
Object.defineProperties(MutationRecord.prototype, {
  ...
  attributeName: {get(){ v_console_log("  [*] MutationRecord -> attributeName[get]", "class");return "class" }},
  oldValue: {get(){ v_console_log("  [*] MutationRecord -> oldValue[get]", "F5Mbv3g1 LivePlayer_LivingPlayer douyin-player douyin-player-controls-autohide kwuig84h douyin-player-active douyin-player-focus");return "F5Mbv3g1 LivePlayer_LivingPlayer douyin-player douyin-player-controls-autohide kwuig84h douyin-player-active douyin-player-focus" }},
...
Object.defineProperties(DOMRectReadOnly.prototype, {
  ...
  width: {get(){ v_console_log("  [*] DOMRectReadOnly -> width[get]", 238.84375);return 238.84375 }},
  height: {get(){ v_console_log("  [*] DOMRectReadOnly -> height[get]", 22.75);return 22.75 }},
  bottom: {get(){ v_console_log("  [*] DOMRectReadOnly -> bottom[get]", 22.75);return 22.75 }},
  right: {get(){ v_console_log("  [*] DOMRectReadOnly -> right[get]", 238.84375);return 238.84375 }},
...
Object.defineProperties(EventCounts.prototype, {
  size: {get(){ v_console_log("  [*] EventCounts -> size[get]", 36);return 36 }},
...
Object.defineProperties(Scheduler.prototype, {
  postTask: {value: v_saf(function postTask(){v_console_log("  [*] Scheduler -> postTask[func]", [].slice.call(arguments));})},
...
Object.defineProperties(FinalizationRegistry.prototype, {
  register: {value: v_saf(function register(){v_console_log("  [*] FinalizationRegistry -> register[func]", [].slice.call(arguments));})},
  unregister: {value: v_saf(function unregister(){v_console_log("  [*] FinalizationRegistry -> unregister[func]", [].slice.call(arguments));})},
...
Object.defineProperties(CanvasRenderingContext2D.prototype, {
  ...
  filter: {set(){ v_console_log("  [*] CanvasRenderingContext2D -> filter[set]", [].slice.call(arguments)); }},
  drawImage: {value: v_saf(function drawImage(){v_console_log("  [*] CanvasRenderingContext2D -> drawImage[func]", [].slice.call(arguments));})},
  createRadialGradient: {value: v_saf(function createRadialGradient(){v_console_log("  [*] CanvasRenderingContext2D -> createRadialGradient[func]", [].slice.call(arguments));})},
  ...
  lineTo: {value: v_saf(function lineTo(){v_console_log("  [*] CanvasRenderingContext2D -> lineTo[func]", [].slice.call(arguments));})},
...
Object.defineProperties(MediaCapabilities.prototype, {
  decodingInfo: {value: v_saf(function decodingInfo(){v_console_log("  [*] MediaCapabilities -> decodingInfo[func]", [].slice.call(arguments));})},
...
Object.defineProperties(CustomElementRegistry.prototype, {
  define: {value: v_saf(function define(){v_console_log("  [*] CustomElementRegistry -> define[func]", [].slice.call(arguments));})},
...
Object.defineProperties(VideoFrame.prototype, {
  close: {value: v_saf(function close(){v_console_log("  [*] VideoFrame -> close[func]", [].slice.call(arguments));})},
...
Object.defineProperties(PerformanceTiming.prototype, {
  loadEventEnd: {get(){ v_console_log("  [*] PerformanceTiming -> loadEventEnd[get]", 1788835542198);return 1788835542198 }},
  navigationStart: {get(){ v_console_log("  [*] PerformanceTiming -> navigationStart[get]", 1788835540821);return 1788835540821 }},
...
Object.defineProperties(CanvasGradient.prototype, {
  addColorStop: {value: v_saf(function addColorStop(){v_console_log("  [*] CanvasGradient -> addColorStop[func]", [].slice.call(arguments));})},
...
Object.defineProperties(SVGRect.prototype, {
  x: {get(){ v_console_log("  [*] SVGRect -> x[get]", 10.5);return 10.5 }},
  y: {get(){ v_console_log("  [*] SVGRect -> y[get]", 20.25);return 20.25 }},
  width: {get(){ v_console_log("  [*] SVGRect -> width[get]", 123.45000457763672);return 123.45000457763672 }},
  height: {get(){ v_console_log("  [*] SVGRect -> height[get]", 67.88999938964844);return 67.88999938964844 }},
...
Object.defineProperties(WebGL2RenderingContext.prototype, {
  createShader: {value: v_saf(function createShader(){v_console_log("  [*] WebGL2RenderingContext -> createShader[func]", [].slice.call(arguments));})},
  shaderSource: {value: v_saf(function shaderSource(){v_console_log("  [*] WebGL2RenderingContext -> shaderSource[func]", [].slice.call(arguments));})},
  compileShader: {value: v_saf(function compileShader(){v_console_log("  [*] WebGL2RenderingContext -> compileShader[func]", [].slice.call(arguments));})},
  getShaderParameter: {value: v_saf(function getShaderParameter(){v_console_log("  [*] WebGL2RenderingContext -> getShaderParameter[func]", [].slice.call(arguments));})},
  createProgram: {value: v_saf(function createProgram(){v_console_log("  [*] WebGL2RenderingContext -> createProgram[func]", [].slice.call(arguments));})},
  attachShader: {value: v_saf(function attachShader(){v_console_log("  [*] WebGL2RenderingContext -> attachShader[func]", [].slice.call(arguments));})},
  linkProgram: {value: v_saf(function linkProgram(){v_console_log("  [*] WebGL2RenderingContext -> linkProgram[func]", [].slice.call(arguments));})},
  getProgramParameter: {value: v_saf(function getProgramParameter(){v_console_log("  [*] WebGL2RenderingContext -> getProgramParameter[func]", [].slice.call(arguments));})},
  useProgram: {value: v_saf(function useProgram(){v_console_log("  [*] WebGL2RenderingContext -> useProgram[func]", [].slice.call(arguments));})},
  getAttribLocation: {value: v_saf(function getAttribLocation(){v_console_log("  [*] WebGL2RenderingContext -> getAttribLocation[func]", [].slice.call(arguments));})},
  getUniformLocation: {value: v_saf(function getUniformLocation(){v_console_log("  [*] WebGL2RenderingContext -> getUniformLocation[func]", [].slice.call(arguments));})},
  createBuffer: {value: v_saf(function createBuffer(){v_console_log("  [*] WebGL2RenderingContext -> createBuffer[func]", [].slice.call(arguments));})},
  bindBuffer: {value: v_saf(function bindBuffer(){v_console_log("  [*] WebGL2RenderingContext -> bindBuffer[func]", [].slice.call(arguments));})},
  vertexAttribPointer: {value: v_saf(function vertexAttribPointer(){v_console_log("  [*] WebGL2RenderingContext -> vertexAttribPointer[func]", [].slice.call(arguments));})},
  enableVertexAttribArray: {value: v_saf(function enableVertexAttribArray(){v_console_log("  [*] WebGL2RenderingContext -> enableVertexAttribArray[func]", [].slice.call(arguments));})},
  uniformMatrix3fv: {value: v_saf(function uniformMatrix3fv(){v_console_log("  [*] WebGL2RenderingContext -> uniformMatrix3fv[func]", [].slice.call(arguments));})},
  clearColor: {value: v_saf(function clearColor(){v_console_log("  [*] WebGL2RenderingContext -> clearColor[func]", [].slice.call(arguments));})},
  clear: {value: v_saf(function clear(){v_console_log("  [*] WebGL2RenderingContext -> clear[func]", [].slice.call(arguments));})},
  bufferData: {value: v_saf(function bufferData(){v_console_log("  [*] WebGL2RenderingContext -> bufferData[func]", [].slice.call(arguments));})},
  drawArrays: {value: v_saf(function drawArrays(){v_console_log("  [*] WebGL2RenderingContext -> drawArrays[func]", [].slice.call(arguments));})},
  readPixels: {value: v_saf(function readPixels(){v_console_log("  [*] WebGL2RenderingContext -> readPixels[func]", [].slice.call(arguments));})},
  getExtension: {value: v_saf(function getExtension(){v_console_log("  [*] WebGL2RenderingContext -> getExtension[func]", [].slice.call(arguments));})},
...
Object.defineProperties(FontFace.prototype, {
  ...
  family: {get(){ v_console_log("  [*] FontFace -> family[get]", "\"Segoe UI Emoji\"");return "\"Segoe UI Emoji\"" }},
...
Object.defineProperties(ResizeObserverSize.prototype, {
  inlineSize: {get(){ v_console_log("  [*] ResizeObserverSize -> inlineSize[get]", 320);return 320 }},
  blockSize: {get(){ v_console_log("  [*] ResizeObserverSize -> blockSize[get]", 42.28125);return 42.28125 }},
...
Object.defineProperties(Performance.prototype, {
  ...
  eventCounts: {get(){ v_console_log("  [*] Performance -> eventCounts[get]", {});return {} }},
...
Object.defineProperties(Node.prototype, {
  ...
  baseURI: {get(){ v_console_log("  [*] Node -> baseURI[get]", "https://live.douyin.com/6096197105?activity_name=&anchor_id=60241003767&banner_type=recommend&category_name=all&page_type=live_main_page&user_id=2685448719442378");return "https://live.douyin.com/6096197105?activity_name=&anchor_id=60241003767&banner_type=recommend&category_name=all&page_type=live_main_page&user_id=2685448719442378" }},
...
Object.defineProperties(MessagePort.prototype, {
  ...
  start: {value: v_saf(function start(){v_console_log("  [*] MessagePort -> start[func]", [].slice.call(arguments));})},
...
Object.defineProperties(XMLHttpRequestEventTarget.prototype, {
  ...
  onload: {set(){ v_console_log("  [*] XMLHttpRequestEventTarget -> onload[set]", [].slice.call(arguments));return {} }},
  onerror: {set(){ v_console_log("  [*] XMLHttpRequestEventTarget -> onerror[set]", [].slice.call(arguments));return {} }},
...
Object.defineProperties(BaseAudioContext.prototype, {
  ...
  sampleRate: {get(){ v_console_log("  [*] BaseAudioContext -> sampleRate[get]", 44100);return 44100 }},
  onstatechange: {set(){ v_console_log("  [*] BaseAudioContext -> onstatechange[set]", [].slice.call(arguments));return 44100 }},
  createAnalyser: {value: v_saf(function createAnalyser(){v_console_log("  [*] BaseAudioContext -> createAnalyser[func]", [].slice.call(arguments));})},
...
Object.defineProperties(MediaStream.prototype, {
  getVideoTracks: {value: v_saf(function getVideoTracks(){v_console_log("  [*] MediaStream -> getVideoTracks[func]", [].slice.call(arguments));})},
  addTrack: {value: v_saf(function addTrack(){v_console_log("  [*] MediaStream -> addTrack[func]", [].slice.call(arguments));})},
  getAudioTracks: {value: v_saf(function getAudioTracks(){v_console_log("  [*] MediaStream -> getAudioTracks[func]", [].slice.call(arguments));})},
...
Object.defineProperties(MediaStreamTrack.prototype, {
  id: {get(){ v_console_log("  [*] MediaStreamTrack -> id[get]", "806e15bd-188c-4afa-b30d-4b561bd32bbc");return "806e15bd-188c-4afa-b30d-4b561bd32bbc" }},
  getSettings: {value: v_saf(function getSettings(){v_console_log("  [*] MediaStreamTrack -> getSettings[func]", [].slice.call(arguments));})},
...
Object.defineProperties(DOMRect.prototype, {
  width: {get(){ v_console_log("  [*] DOMRect -> width[get]", 320);return 320 }},
  height: {get(){ v_console_log("  [*] DOMRect -> height[get]", 42.28571701049805);return 42.28571701049805 }},
  x: {get(){ v_console_log("  [*] DOMRect -> x[get]", -147.34365844726562);return -147.34365844726562 }},
  y: {get(){ v_console_log("  [*] DOMRect -> y[get]", -175.12490844726562);return -175.12490844726562 }},
  [Symbol.toStringTag]: {value:"DOMRect",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(ErrorEvent.prototype, {
  error: {get(){ v_console_log("  [*] ErrorEvent -> error[get]", {});return {} }},
  [Symbol.toStringTag]: {value:"ErrorEvent",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(MessageEvent.prototype, {
  data: {get(){ v_console_log("  [*] MessageEvent -> data[get]", {});return {} }},
  origin: {get(){ v_console_log("  [*] MessageEvent -> origin[get]", "https://lf-normal-gr-sourcecdn.bytegecko.com");return "https://lf-normal-gr-sourcecdn.bytegecko.com" }},
...
Object.defineProperties(AudioNode.prototype, {
  channelCount: {get(){ v_console_log("  [*] AudioNode -> channelCount[get]", 2);return 2 }},
...
Object.defineProperties(webkitMediaStream.prototype, {
  getVideoTracks: {value: v_saf(function getVideoTracks(){v_console_log("  [*] webkitMediaStream -> getVideoTracks[func]", [].slice.call(arguments));})},
  addTrack: {value: v_saf(function addTrack(){v_console_log("  [*] webkitMediaStream -> addTrack[func]", [].slice.call(arguments));})},
  getAudioTracks: {value: v_saf(function getAudioTracks(){v_console_log("  [*] webkitMediaStream -> getAudioTracks[func]", [].slice.call(arguments));})},
  [Symbol.toStringTag]: {value:"webkitMediaStream",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(Screen.prototype, {
  width: {get(){ v_console_log("  [*] Screen -> width[get]", 1463);return 1463 }},
  height: {get(){ v_console_log("  [*] Screen -> height[get]", 915);return 915 }},
  availWidth: {get(){ v_console_log("  [*] Screen -> availWidth[get]", 1463);return 1463 }},
  availHeight: {get(){ v_console_log("  [*] Screen -> availHeight[get]", 867);return 867 }},
...
Object.defineProperties(WebSocket.prototype, {
  ...
  readyState: {get(){ v_console_log("  [*] WebSocket -> readyState[get]", 1);return 1 }},
...
Object.defineProperties(PerformanceResourceTiming.prototype, {
  requestStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> requestStart[get]", 8.400000035762787);return 8.400000035762787 }},
  workerStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> workerStart[get]", 8.300000011920929);return 8.300000011920929 }},
  responseStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> responseStart[get]", 17.80000001192093);return 17.80000001192093 }},
  encodedBodySize: {get(){ v_console_log("  [*] PerformanceResourceTiming -> encodedBodySize[get]", 6707);return 6707 }},
  responseEnd: {get(){ v_console_log("  [*] PerformanceResourceTiming -> responseEnd[get]", 229.10000002384186);return 229.10000002384186 }},
  transferSize: {get(){ v_console_log("  [*] PerformanceResourceTiming -> transferSize[get]", 0);return 0 }},
  fetchStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> fetchStart[get]", 8.400000035762787);return 8.400000035762787 }},
  redirectStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> redirectStart[get]", 0);return 0 }},
  domainLookupStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> domainLookupStart[get]", 8.400000035762787);return 8.400000035762787 }},
  domainLookupEnd: {get(){ v_console_log("  [*] PerformanceResourceTiming -> domainLookupEnd[get]", 8.400000035762787);return 8.400000035762787 }},
...
Object.defineProperties(PerformanceMeasure.prototype, {
  detail: {get(){ v_console_log("  [*] PerformanceMeasure -> detail[get]", {});return {} }},
...
Object.defineProperties(StorageEvent.prototype, {
  key: {get(){ v_console_log("  [*] StorageEvent -> key[get]", "SLARDARanniex_web_webcast");return "SLARDARanniex_web_webcast" }},
...
Object.defineProperties(LayoutShift.prototype, {
  ...
  value: {get(){ v_console_log("  [*] LayoutShift -> value[get]", 0.003861840663021775);return 0.003861840663021775 }},
...
Object.defineProperties(Document.prototype, {
  ...
  referrer: {get(){ v_console_log("  [*] Document -> referrer[get]", "https://live.douyin.com/6096197105?activity_name=&anchor_id=60241003767&banner_type=recommend&category_name=all&page_type=live_main_page&user_id=2685448719442378");return "https://live.douyin.com/6096197105?activity_name=&anchor_id=60241003767&banner_type=recommend&category_name=all&page_type=live_main_page&user_id=2685448719442378" }},
  ...
  title: {get(){ v_console_log("  [*] Document -> title[get]", "Gus的抖音直播间 - 抖音直播");return "Gus的抖音直播间 - 抖音直播" },set(){ v_console_log("  [*] Document -> title[set]", [].slice.call(arguments));return "Gus的抖音直播间 - 抖音直播" }},
  pictureInPictureEnabled: {get(){ v_console_log("  [*] Document -> pictureInPictureEnabled[get]", true);return true }},
  ...
  domain: {get(){ v_console_log("  [*] Document -> domain[get]", "live.douyin.com");return "live.douyin.com" }},
  wasDiscarded: {get(){ v_console_log("  [*] Document -> wasDiscarded[get]", false);return false }},
  pictureInPictureElement: {get(){ v_console_log("  [*] Document -> pictureInPictureElement[get]", {});return {} }},
  webkitFullscreenElement: {get(){ v_console_log("  [*] Document -> webkitFullscreenElement[get]", {});return {} }},
  ...
  fonts: {get(){ v_console_log("  [*] Document -> fonts[get]", {});return {} }},
...
Object.defineProperties(Element.prototype, {
  ...
  replaceWith: {value: v_saf(function replaceWith(){v_console_log("  [*] Element -> replaceWith[func]", [].slice.call(arguments));})},
  classList: {get(){ v_console_log("  [*] Element -> classList[get]", {});return {} }},
  prepend: {value: v_saf(function prepend(){v_console_log("  [*] Element -> prepend[func]", [].slice.call(arguments));})},
  ...
  childElementCount: {get(){ v_console_log("  [*] Element -> childElementCount[get]", 8);return 8 }},
  append: {value: v_saf(function append(){v_console_log("  [*] Element -> append[func]", [].slice.call(arguments));})},
  clientWidth: {get(){ v_console_log("  [*] Element -> clientWidth[get]", 280);return 280 }},
  clientHeight: {get(){ v_console_log("  [*] Element -> clientHeight[get]", 144);return 144 }},
  ...
  before: {value: v_saf(function before(){v_console_log("  [*] Element -> before[func]", [].slice.call(arguments));})},
  ...
  className: {get(){ v_console_log("  [*] Element -> className[get]", "ace-line");return "ace-line" },set(){ v_console_log("  [*] Element -> className[set]", [].slice.call(arguments));return "ace-line" }},
  outerHTML: {get(){ v_console_log("  [*] Element -> outerHTML[get]", "<html style=\"font-size: calc(100vw * 100 / 375); width: 100%; height: 100%; margin: 0px; padding: 0px; overflow: hidden;\"><head><base href=\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/\"><style>body { margin: 0 !important; } html { font-size: 100px !important }body{ background-color:ff060a19;}</style><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">window.__globalprops = {\"bottomHeight\":0,\"isAccessable\":0,\"isFoldableDevice\":0,\"isIPhoneX\":0,\"isPad\":0,\"isLandscape\":0,\"isLogin\":0,\"originUrl\":\"sslocal://lynxview?url=https%3A%2F%2Flf-dy-gr-sourcecdn.bytegecko.com%2Fobj%2Fbyte-gurd-source-gr%2Fwebcast%2Fmono%2Flynx%2Fgamecp_shorttouch_lynx_pc%2Fpages%2Fgame_point_box%2Ftemplate.js%3Froom_id%3D7682955227602897679%26user_id%3D2685448719442378%26sec_user_id%3DMS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew%26anchor_id%3D60241003767%26anchor_id_str%3D60241003767%26sec_anchor_id%3DMS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI%26enter_from_merge%3Dweb_live%26video_id%3Dundefined%26is_ad%3D0%26request_id%3Dundefined%26enter_method%3Dweb_banner%26user_unique_id%3D7682259617964197414%26user_agent%3DMozilla%252F5.0%2B%2528Windows%2BNT%2B10.0%253B%2BWin64%253B%2Bx64%2529%2BAppleWebKit%252F537.36%2B%2528KHTML%252C%2Blike%2BGecko%2529%2BChrome%252F152.0.0.0%2BSafari%252F537.36%2BEdg%252F152.0.0.0%26action_type%3Dclick%26pc_client_type%3D1%26pc_client_version%3D&type=popup&gravity=bottom&height_percent=75&web_bg_color=ff060a19&radius=23&radius_bottom_right=0&radius_bottom_left=0&enable_preload=all&add_safe_area_height=0&use_wk_falcon=2&global_props=%7B%22room_id%22%3A%227682955227602897679%22%2C%22user_id%22%3A%222685448719442378%22%2C%22sec_user_id%22%3A%22MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew%22%2C%22anchor_id%22%3A%2260241003767%22%2C%22anchor_id_str%22%3A%2260241003767%22%2C%22sec_anchor_id%22%3A%22MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI%22%2C%22enter_from_merge%22%3A%22web_live%22%2C%22is_ad%22%3A0%2C%22enter_method%22%3A%22web_banner%22%2C%22user_unique_id%22%3A%227682259617964197414%22%2C%22user_agent%22%3A%22Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0%22%2C%22action_type%22%3A%22click%22%2C%22pc_client_type%22%3A1%2C%22pc_client_version%22%3A%22%22%7D\",\"region\":\"CN\",\"aid\":\"6383\",\"appLang\":\"zh-CN\",\"appName\":\"douyin_pc\",\"appTheme\":\"dark\",\"appVersion\":\"1.1.5.5223\",\"updateVersionCode\":\"0.0.1\",\"channel\":\"douyin_pc\",\"deviceId\":\"7682259617964197414\",\"lang\":\"zh-CN\",\"os\":\"Web\",\"osVersion\":\"19.0.0\",\"is32\":false,\"deviceModel\":\"unknown\",\"screenWidth\":374,\"screenHeight\":867,\"queryItems\":{\"url\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js?room_id=7682955227602897679&user_id=2685448719442378&sec_user_id=MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew&anchor_id=60241003767&anchor_id_str=60241003767&sec_anchor_id=MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI&enter_from_merge=web_live&video_id=undefined&is_ad=0&request_id=undefined&enter_method=web_banner&user_unique_id=7682259617964197414&user_agent=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0&action_type=click&pc_client_type=1&pc_client_version=\",\"type\":\"popup\",\"gravity\":\"bottom\",\"height_percent\":\"75\",\"web_bg_color\":\"ff060a19\",\"radius\":\"23\",\"radius_bottom_right\":\"0\",\"radius_bottom_left\":\"0\",\"enable_preload\":\"all\",\"add_safe_area_height\":\"0\",\"use_wk_falcon\":\"2\",\"global_props\":\"{\\\"room_id\\\":\\\"7682955227602897679\\\",\\\"user_id\\\":\\\"2685448719442378\\\",\\\"sec_user_id\\\":\\\"MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew\\\",\\\"anchor_id\\\":\\\"60241003767\\\",\\\"anchor_id_str\\\":\\\"60241003767\\\",\\\"sec_anchor_id\\\":\\\"MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI\\\",\\\"enter_from_merge\\\":\\\"web_live\\\",\\\"is_ad\\\":0,\\\"enter_method\\\":\\\"web_banner\\\",\\\"user_unique_id\\\":\\\"7682259617964197414\\\",\\\"user_agent\\\":\\\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0\\\",\\\"action_type\\\":\\\"click\\\",\\\"pc_client_type\\\":1,\\\"pc_client_version\\\":\\\"\\\"}\"},\"resolvedUrl\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js\",\"bulletStorageValues\":{},\"userDomainStorageValues\":{},\"location\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js?room_id=7682955227602897679&user_id=2685448719442378&sec_user_id=MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew&anchor_id=60241003767&anchor_id_str=60241003767&sec_anchor_id=MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI&enter_from_merge=web_live&video_id=undefined&is_ad=0&request_id=undefined&enter_method=web_banner&user_unique_id=7682259617964197414&user_agent=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0&action_type=click&pc_client_type=1&pc_client_version=\",\"device_platform\":\"web\",\"room_id\":\"7682955227602897679\",\"user_id\":\"2685448719442378\",\"sec_user_id\":\"MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew\",\"anchor_id\":\"60241003767\",\"anchor_id_str\":\"60241003767\",\"sec_anchor_id\":\"MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI\",\"enter_from_merge\":\"web_live\",\"is_ad\":0,\"enter_method\":\"web_banner\",\"user_unique_id\":\"7682259617964197414\",\"user_agent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0\",\"action_type\":\"click\",\"pc_client_type\":1,\"pc_client_version\":\"\",\"contentHeight\":36,\"contentWidth\":36,\"containerID\":\"@annie/web_4lrqkiar03i_2\"}</script><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n(()=>{\n  const value = {\n    _invokeMethod(data) {\n      parent.postMessage({\n        type: '@annie/web/jsb_call',\n        provider: '',\n        nameSpace: 'default',\n        data,\n        containerID: '@annie/web_4lrqkiar03i_2',\n      });\n    },\n    _invokeError(data) {\n      parent.postMessage({\n        type: '@annie/web/jsb_error',\n        provider: '',\n        nameSpace: 'default',\n        data,\n        containerID: '@annie/web_4lrqkiar03i_2',\n      });\n    }\n  };\n  Object.freeze(value);\n  Object.defineProperty(window, 'JS2NativeBridge', { value })\n})();\n  addEventListener('message', event => {\n    if (event.data.type !== '@annie/web/jsb_callback') {\n      return;\n    }\n    const paramStr = event.data.data;\n    let params = {};\n    try {\n      params = JSON.parse(paramStr);\n    } catch(err) {\n      console.log('callBackDataError:', err); \n    }\n\n    if (window.JSBridge && window.JSBridge._handleMessageFromApp) {\n      JSBridge._handleMessageFromApp(params);\n    } else if (window.Native2JSBridge && window.Native2JSBridge._handleMessageFromApp) {\n      Native2JSBridge._handleMessageFromApp(params);\n    }\n  });\n  </script>\n    <title>抖音直播</title>\n    <meta name=\"viewport\" content=\"width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no\">\n    <meta name=\"apple-mobile-web-app-capable\" content=\"yes\">\n    <meta name=\"apple-mobile-web-app-status-bar-style\" content=\"default\">\n    <meta name=\"screen-orientation\" content=\"portrait\">\n    <meta name=\"format-detection\" content=\"telephone=no\">\n    <meta name=\"x5-orientation\" content=\"portrait\">\n<meta name=\"apple-mobile-web-app-capable\" content=\"yes\"><meta name=\"apple-mobile-web-app-status-bar-style\" content=\"default\"><meta name=\"screen-orientation\" content=\"portrait\"><meta name=\"format-detection\" content=\"telephone=no\"><meta name=\"x5-orientation\" content=\"portrait\"><script type=\"module\" src=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/js/lib-polyfill.a0eb223e.js\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\"></script><script type=\"module\" src=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/js/899.be5fc030.js\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\"></script><script type=\"module\" src=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/js/main.8bdb6942.js\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\"></script><link href=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/css/899.4f420574.css\" rel=\"stylesheet\"><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n    ;(function (w, d, u, b, n, pc, ga, ae, po, s, p, e, t, pp) {pc = 'precollect';ga\n    = 'getAttribute';ae = 'addEventListener';po = 'PerformanceObserver';s = function\n    (m) {p = [].slice.call(arguments);p.push(Date.now(), location.href);(m == pc ?\n    s.p.a : s.q).push(p)};s.q = [];s.p = { a: [] };w[n] = s;e =\n    document.createElement('script');e.src = u + '?bid=' + b + '&globalName=' +\n    n;e.crossOrigin = u.indexOf('sdk-web') > 0 ? 'anonymous' :\n    'use-credentials';d.getElementsByTagName('head')[0].appendChild(e);if (ae in w)\n    {s.pcErr = function (e) {e = e || w.event;t = e.target || e.srcElement;if (t\n    instanceof Element || t instanceof HTMLElement) {if (t[ga]('integrity'))\n    {w[n](pc, 'sri', t[ga]('href') || t[ga]('src'))} else {w[n](pc, 'st', { tagName:\n    t.tagName, url: t[ga]('href') || t[ga]('src') })}} else {w[n](pc, 'err', e.error)}};s.pcRej = function (e) {e = e || w.event;w[n](pc, 'reject',\n    e.reason || (e.detail && e.detail.reason))};w[ae]('error', s.pcErr,\n    true);w[ae]('unhandledrejection', s.pcRej,\n    true);};if('PerformanceLongTaskTiming' in w) {pp = s.pp = { entries: []\n    };pp.observer = new PerformanceObserver(function (l) {pp.entries =\n    pp.entries.concat(l.getEntries())});pp.observer.observe({ entryTypes:\n    ['longtask']\n    })}})(window,document,'https://lf3-short.ibytedapm.com/slardar/fe/sdk-web/browser.cn.js','anniex_web_webcast','__AnniexWebSlardar');\n\n\n    window.__AnniexWebSlardar('init', {\n      bid: 'anniex_web_webcast',\n      pid: 'https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js',\n      userId: '2685448719442378',\n      env: 'production',\n      plugins: {\n        blankScreen: {\n          screenshot: false,\n        }\n      },\n    })\n\n    window.__AnniexWebSlardar('start')\n\n  </script><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n    // window.callBackMap = new Map();\n    window.promiseMap = new Map();\n    window._generateCallbackId = (function() {\n      var counter = 0;\n   \n      return function(name) {\n        const seq = (counter++).toString(36); // 自增序列转36进制\n        return name + '-' + seq;\n      }\n    })();\n\n    window.__cleanup = function(callbackId) {\n      const promiseInfo = promiseMap.get(callbackId);\n      if (promiseInfo) {\n        clearTimeout(promiseInfo.timeoutId);\n        promiseMap.delete(callbackId);\n      }\n    }\n\n    window._onNativeModulesCall = function(name, data, moduleName) {\n\n      return new Promise((resolve, reject) => {\n        var __callback_id = _generateCallbackId(name);\n        \n        // 存储resolve和reject以便后续调用\n        promiseMap.set(__callback_id, { resolve, reject });\n\n        // 设置超时自动清理（例如10秒）\n        var timeoutId = setTimeout(() => {\n          promiseMap.delete(__callback_id);\n          reject(new Error('API call timeout'));\n        }, 10000);\n\n        // 将超时ID存储在元数据中\n        promiseMap.get(__callback_id).timeoutId = timeoutId;\n\n        try {\n          window.JS2NativeBridge._invokeMethod(JSON.stringify({\n            func: name,\n            params: data.data || {},\n            __callback_id: __callback_id,\n          }));\n        } catch (error) {\n          // 如果调用失败立即reject\n          window.__cleanup(__callback_id);\n          reject(error);\n        }\n      });\n\n    };\n    window.Native2JSBridge = {\n      _handleMessageFromApp(data) {\n        var result, callback_id, msgType;\n        msgType = data.__msg_type;\n        if (msgType == \"event\") {\n          var lynxView = document.querySelector('lynx-view');\n          var eventId = data.__event_id;\n          var params = data.__params;\n          if (lynxView && eventId) {\n            lynxView.sendGlobalEvent(eventId, [params])\n          }\n        } else if (msgType == \"callback\") {\n          callback_id = data.__callback_id;\n          result = data.__params.data;\n          result.code = data.__params.code;\n          var promiseInfo = promiseMap.get(callback_id);\n          if (!promiseInfo) {\n            console.warn('unknown callback ID:' + callback_id);\n            return;\n          }\n          window.__cleanup(callback_id);\n\n          promiseInfo.resolve(result);\n        }\n      },\n      _updateData(data) {\n        const lynxView = document.querySelector('lynx-view');\n        if (lynxView) {\n          try {\n            const parsedData = JSON.parse(data);\n            lynxView.updateData(parsedData.__params || {});\n          } catch(err) {\n            console.log('updateDataError:', err); \n          }\n        }\n      }\n    };\n \n    addEventListener('message', event => {\n      if (event.data.type !== '@annie/web/jsb_update_data') {\n        return;\n      }\n      const paramStr = event.data.data;\n      if (window.JSBridge && window.JSBridge._updateData) {\n        JSBridge._updateData(paramStr);\n      } else if (window.Native2JSBridge && window.Native2JSBridge._updateData) {\n        Native2JSBridge._updateData(paramStr);\n      }\n    });\n\n    </script><script type=\"module\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n      function processError(error, replacementPath, lineOffset) {\n        const ErrorConstructor = error.constructor;\n        const newError = new ErrorConstructor(error.message);\n\n        Object.getOwnPropertyNames(error).forEach(key => {\n          if (key !== 'stack') newError[key] = error[key];\n        });\n\n        if (typeof error.stack === 'string') {\n          // 修复：正确转义正则表达式\n          const blobRegex = /blob:(https?:\\/\\/[^:]+):(\\d+):(\\d+)/g;\n          \n          let processedStack = error.stack.replace(blobRegex, function(match, url, lineStr, columnStr) {\n            const lineNum = parseInt(lineStr, 10);\n            const columnNum = parseInt(columnStr, 10);\n            const adjustedLine = isNaN(lineNum) ? lineStr : Math.max(1, lineNum - lineOffset);\n            \n            return replacementPath + ':' + adjustedLine + ':' + columnNum;\n          });\n\n          newError.stack = processedStack;\n        }\n\n        return newError;\n      }\n\n      const initView = () => {\n          var globalProps = window.__globalprops;\n          document.body.innerHTML = '<lynx-view style=\"height:100%; width:100%;\"></lynx-view>';\n          const initData = {\"type\":30,\"min_webcast_sdk_version\":1670,\"short_touch_type\":2,\"priority\":2,\"short_touch_info\":{\"short_touch_url\":\"https://lf-webcast-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx/pages/game_point_box/template.js\",\"short_touch_fallback_url\":\"https://lf-webcast-sourcecdn-tos.bytegecko.com/obj/byte-gurd-source/webcast/mono/lynx/short_touch/h5/pages/predictor_box/index.html\",\"short_touch_url_pc\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js\",\"container_type\":1,\"width\":36,\"height\":36,\"jump_schema\":\"\",\"show_animation\":1,\"animation_type\":4,\"sub_item_list\":[\"{\\\"count\\\":0, \\\"readyBoxNum\\\": 1}\"],\"accessible_name\":\"领取游戏积分\"}};\n          // 属性设置\n          const lynxView = document.querySelector('lynx-view');\n          if (lynxView) {\n          // 设置gourpId\n          if (1){\n              lynxView.lynxGroupId = 1;\n          }\n          lynxView.globalProps = window.__globalprops;\n          // 设置初始值\n          try {\n              lynxView.initData = initData;\n          } catch(err) { }\n          lynxView.width = '100%';\n          lynxView.height = '100%';\n          lynxView.onNativeModulesCall = window._onNativeModulesCall;\n          customElements.whenDefined('lynx-view').then(() => {\n              lynxView.onNativeModulesCall = window._onNativeModulesCall;\n          });\n  \n          // 错误上报 并匹配产物sourceMap 获取到实际的产物地址\n          lynxView.addEventListener('error', (e) => {\n              if (false) {\n                  console.error('Lynx View Error:', e.detail);\n              } else {\n                  lynxView.setAttribute('style', 'display:none');\n                  lynxView.innerHTML = '';\n                  window.JS2NativeBridge._invokeError('lynxView error');\n              }\n              if (e.detail && e.detail.fileName === 'app-service.js') {\n                const error = e.detail.error;\n                const processedError = processError(error, \"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js\", 2);\n                window.__AnniexWebSlardar('captureException', processedError);\n              }\n          });\n          lynxView.url = \"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js?room_id=7682955227602897679&user_id=2685448719442378&sec_user_id=MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew&anchor_id=60241003767&anchor_id_str=60241003767&sec_anchor_id=MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI&enter_from_merge=web_live&video_id=undefined&is_ad=0&request_id=undefined&enter_method=web_banner&user_unique_id=7682259617964197414&user_agent=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0&action_type=click&pc_client_type=1&pc_client_version=&device_platform=iphone&app_id=6383&app_version=18.9.0&gecko_bkt=7\";\n        }\n      };\n\n      if (customElements.get('lynx-view')) {\n        initView();\n      } else {\n        customElements.whenDefined('lynx-view').then(() => {\n          initView();\n        });\n      }\n    </script></head>\n\n<body style=\"width: 100%; height: 100%; margin: 0px 0px; padding: 0px;\">\n    <div id=\"root\"></div>\n\n\n</body></html>");return "<html style=\"font-size: calc(100vw * 100 / 375); width: 100%; height: 100%; margin: 0px; padding: 0px; overflow: hidden;\"><head><base href=\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/\"><style>body { margin: 0 !important; } html { font-size: 100px !important }body{ background-color:ff060a19;}</style><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">window.__globalprops = {\"bottomHeight\":0,\"isAccessable\":0,\"isFoldableDevice\":0,\"isIPhoneX\":0,\"isPad\":0,\"isLandscape\":0,\"isLogin\":0,\"originUrl\":\"sslocal://lynxview?url=https%3A%2F%2Flf-dy-gr-sourcecdn.bytegecko.com%2Fobj%2Fbyte-gurd-source-gr%2Fwebcast%2Fmono%2Flynx%2Fgamecp_shorttouch_lynx_pc%2Fpages%2Fgame_point_box%2Ftemplate.js%3Froom_id%3D7682955227602897679%26user_id%3D2685448719442378%26sec_user_id%3DMS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew%26anchor_id%3D60241003767%26anchor_id_str%3D60241003767%26sec_anchor_id%3DMS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI%26enter_from_merge%3Dweb_live%26video_id%3Dundefined%26is_ad%3D0%26request_id%3Dundefined%26enter_method%3Dweb_banner%26user_unique_id%3D7682259617964197414%26user_agent%3DMozilla%252F5.0%2B%2528Windows%2BNT%2B10.0%253B%2BWin64%253B%2Bx64%2529%2BAppleWebKit%252F537.36%2B%2528KHTML%252C%2Blike%2BGecko%2529%2BChrome%252F152.0.0.0%2BSafari%252F537.36%2BEdg%252F152.0.0.0%26action_type%3Dclick%26pc_client_type%3D1%26pc_client_version%3D&type=popup&gravity=bottom&height_percent=75&web_bg_color=ff060a19&radius=23&radius_bottom_right=0&radius_bottom_left=0&enable_preload=all&add_safe_area_height=0&use_wk_falcon=2&global_props=%7B%22room_id%22%3A%227682955227602897679%22%2C%22user_id%22%3A%222685448719442378%22%2C%22sec_user_id%22%3A%22MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew%22%2C%22anchor_id%22%3A%2260241003767%22%2C%22anchor_id_str%22%3A%2260241003767%22%2C%22sec_anchor_id%22%3A%22MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI%22%2C%22enter_from_merge%22%3A%22web_live%22%2C%22is_ad%22%3A0%2C%22enter_method%22%3A%22web_banner%22%2C%22user_unique_id%22%3A%227682259617964197414%22%2C%22user_agent%22%3A%22Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0%22%2C%22action_type%22%3A%22click%22%2C%22pc_client_type%22%3A1%2C%22pc_client_version%22%3A%22%22%7D\",\"region\":\"CN\",\"aid\":\"6383\",\"appLang\":\"zh-CN\",\"appName\":\"douyin_pc\",\"appTheme\":\"dark\",\"appVersion\":\"1.1.5.5223\",\"updateVersionCode\":\"0.0.1\",\"channel\":\"douyin_pc\",\"deviceId\":\"7682259617964197414\",\"lang\":\"zh-CN\",\"os\":\"Web\",\"osVersion\":\"19.0.0\",\"is32\":false,\"deviceModel\":\"unknown\",\"screenWidth\":374,\"screenHeight\":867,\"queryItems\":{\"url\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js?room_id=7682955227602897679&user_id=2685448719442378&sec_user_id=MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew&anchor_id=60241003767&anchor_id_str=60241003767&sec_anchor_id=MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI&enter_from_merge=web_live&video_id=undefined&is_ad=0&request_id=undefined&enter_method=web_banner&user_unique_id=7682259617964197414&user_agent=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0&action_type=click&pc_client_type=1&pc_client_version=\",\"type\":\"popup\",\"gravity\":\"bottom\",\"height_percent\":\"75\",\"web_bg_color\":\"ff060a19\",\"radius\":\"23\",\"radius_bottom_right\":\"0\",\"radius_bottom_left\":\"0\",\"enable_preload\":\"all\",\"add_safe_area_height\":\"0\",\"use_wk_falcon\":\"2\",\"global_props\":\"{\\\"room_id\\\":\\\"7682955227602897679\\\",\\\"user_id\\\":\\\"2685448719442378\\\",\\\"sec_user_id\\\":\\\"MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew\\\",\\\"anchor_id\\\":\\\"60241003767\\\",\\\"anchor_id_str\\\":\\\"60241003767\\\",\\\"sec_anchor_id\\\":\\\"MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI\\\",\\\"enter_from_merge\\\":\\\"web_live\\\",\\\"is_ad\\\":0,\\\"enter_method\\\":\\\"web_banner\\\",\\\"user_unique_id\\\":\\\"7682259617964197414\\\",\\\"user_agent\\\":\\\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0\\\",\\\"action_type\\\":\\\"click\\\",\\\"pc_client_type\\\":1,\\\"pc_client_version\\\":\\\"\\\"}\"},\"resolvedUrl\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js\",\"bulletStorageValues\":{},\"userDomainStorageValues\":{},\"location\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js?room_id=7682955227602897679&user_id=2685448719442378&sec_user_id=MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew&anchor_id=60241003767&anchor_id_str=60241003767&sec_anchor_id=MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI&enter_from_merge=web_live&video_id=undefined&is_ad=0&request_id=undefined&enter_method=web_banner&user_unique_id=7682259617964197414&user_agent=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0&action_type=click&pc_client_type=1&pc_client_version=\",\"device_platform\":\"web\",\"room_id\":\"7682955227602897679\",\"user_id\":\"2685448719442378\",\"sec_user_id\":\"MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew\",\"anchor_id\":\"60241003767\",\"anchor_id_str\":\"60241003767\",\"sec_anchor_id\":\"MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI\",\"enter_from_merge\":\"web_live\",\"is_ad\":0,\"enter_method\":\"web_banner\",\"user_unique_id\":\"7682259617964197414\",\"user_agent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0\",\"action_type\":\"click\",\"pc_client_type\":1,\"pc_client_version\":\"\",\"contentHeight\":36,\"contentWidth\":36,\"containerID\":\"@annie/web_4lrqkiar03i_2\"}</script><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n(()=>{\n  const value = {\n    _invokeMethod(data) {\n      parent.postMessage({\n        type: '@annie/web/jsb_call',\n        provider: '',\n        nameSpace: 'default',\n        data,\n        containerID: '@annie/web_4lrqkiar03i_2',\n      });\n    },\n    _invokeError(data) {\n      parent.postMessage({\n        type: '@annie/web/jsb_error',\n        provider: '',\n        nameSpace: 'default',\n        data,\n        containerID: '@annie/web_4lrqkiar03i_2',\n      });\n    }\n  };\n  Object.freeze(value);\n  Object.defineProperty(window, 'JS2NativeBridge', { value })\n})();\n  addEventListener('message', event => {\n    if (event.data.type !== '@annie/web/jsb_callback') {\n      return;\n    }\n    const paramStr = event.data.data;\n    let params = {};\n    try {\n      params = JSON.parse(paramStr);\n    } catch(err) {\n      console.log('callBackDataError:', err); \n    }\n\n    if (window.JSBridge && window.JSBridge._handleMessageFromApp) {\n      JSBridge._handleMessageFromApp(params);\n    } else if (window.Native2JSBridge && window.Native2JSBridge._handleMessageFromApp) {\n      Native2JSBridge._handleMessageFromApp(params);\n    }\n  });\n  </script>\n    <title>抖音直播</title>\n    <meta name=\"viewport\" content=\"width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no\">\n    <meta name=\"apple-mobile-web-app-capable\" content=\"yes\">\n    <meta name=\"apple-mobile-web-app-status-bar-style\" content=\"default\">\n    <meta name=\"screen-orientation\" content=\"portrait\">\n    <meta name=\"format-detection\" content=\"telephone=no\">\n    <meta name=\"x5-orientation\" content=\"portrait\">\n<meta name=\"apple-mobile-web-app-capable\" content=\"yes\"><meta name=\"apple-mobile-web-app-status-bar-style\" content=\"default\"><meta name=\"screen-orientation\" content=\"portrait\"><meta name=\"format-detection\" content=\"telephone=no\"><meta name=\"x5-orientation\" content=\"portrait\"><script type=\"module\" src=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/js/lib-polyfill.a0eb223e.js\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\"></script><script type=\"module\" src=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/js/899.be5fc030.js\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\"></script><script type=\"module\" src=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/js/main.8bdb6942.js\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\"></script><link href=\"https://lf-normal-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/h5/react_lynx_web3_douyin/static/css/899.4f420574.css\" rel=\"stylesheet\"><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n    ;(function (w, d, u, b, n, pc, ga, ae, po, s, p, e, t, pp) {pc = 'precollect';ga\n    = 'getAttribute';ae = 'addEventListener';po = 'PerformanceObserver';s = function\n    (m) {p = [].slice.call(arguments);p.push(Date.now(), location.href);(m == pc ?\n    s.p.a : s.q).push(p)};s.q = [];s.p = { a: [] };w[n] = s;e =\n    document.createElement('script');e.src = u + '?bid=' + b + '&globalName=' +\n    n;e.crossOrigin = u.indexOf('sdk-web') > 0 ? 'anonymous' :\n    'use-credentials';d.getElementsByTagName('head')[0].appendChild(e);if (ae in w)\n    {s.pcErr = function (e) {e = e || w.event;t = e.target || e.srcElement;if (t\n    instanceof Element || t instanceof HTMLElement) {if (t[ga]('integrity'))\n    {w[n](pc, 'sri', t[ga]('href') || t[ga]('src'))} else {w[n](pc, 'st', { tagName:\n    t.tagName, url: t[ga]('href') || t[ga]('src') })}} else {w[n](pc, 'err', e.error)}};s.pcRej = function (e) {e = e || w.event;w[n](pc, 'reject',\n    e.reason || (e.detail && e.detail.reason))};w[ae]('error', s.pcErr,\n    true);w[ae]('unhandledrejection', s.pcRej,\n    true);};if('PerformanceLongTaskTiming' in w) {pp = s.pp = { entries: []\n    };pp.observer = new PerformanceObserver(function (l) {pp.entries =\n    pp.entries.concat(l.getEntries())});pp.observer.observe({ entryTypes:\n    ['longtask']\n    })}})(window,document,'https://lf3-short.ibytedapm.com/slardar/fe/sdk-web/browser.cn.js','anniex_web_webcast','__AnniexWebSlardar');\n\n\n    window.__AnniexWebSlardar('init', {\n      bid: 'anniex_web_webcast',\n      pid: 'https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js',\n      userId: '2685448719442378',\n      env: 'production',\n      plugins: {\n        blankScreen: {\n          screenshot: false,\n        }\n      },\n    })\n\n    window.__AnniexWebSlardar('start')\n\n  </script><script nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n    // window.callBackMap = new Map();\n    window.promiseMap = new Map();\n    window._generateCallbackId = (function() {\n      var counter = 0;\n   \n      return function(name) {\n        const seq = (counter++).toString(36); // 自增序列转36进制\n        return name + '-' + seq;\n      }\n    })();\n\n    window.__cleanup = function(callbackId) {\n      const promiseInfo = promiseMap.get(callbackId);\n      if (promiseInfo) {\n        clearTimeout(promiseInfo.timeoutId);\n        promiseMap.delete(callbackId);\n      }\n    }\n\n    window._onNativeModulesCall = function(name, data, moduleName) {\n\n      return new Promise((resolve, reject) => {\n        var __callback_id = _generateCallbackId(name);\n        \n        // 存储resolve和reject以便后续调用\n        promiseMap.set(__callback_id, { resolve, reject });\n\n        // 设置超时自动清理（例如10秒）\n        var timeoutId = setTimeout(() => {\n          promiseMap.delete(__callback_id);\n          reject(new Error('API call timeout'));\n        }, 10000);\n\n        // 将超时ID存储在元数据中\n        promiseMap.get(__callback_id).timeoutId = timeoutId;\n\n        try {\n          window.JS2NativeBridge._invokeMethod(JSON.stringify({\n            func: name,\n            params: data.data || {},\n            __callback_id: __callback_id,\n          }));\n        } catch (error) {\n          // 如果调用失败立即reject\n          window.__cleanup(__callback_id);\n          reject(error);\n        }\n      });\n\n    };\n    window.Native2JSBridge = {\n      _handleMessageFromApp(data) {\n        var result, callback_id, msgType;\n        msgType = data.__msg_type;\n        if (msgType == \"event\") {\n          var lynxView = document.querySelector('lynx-view');\n          var eventId = data.__event_id;\n          var params = data.__params;\n          if (lynxView && eventId) {\n            lynxView.sendGlobalEvent(eventId, [params])\n          }\n        } else if (msgType == \"callback\") {\n          callback_id = data.__callback_id;\n          result = data.__params.data;\n          result.code = data.__params.code;\n          var promiseInfo = promiseMap.get(callback_id);\n          if (!promiseInfo) {\n            console.warn('unknown callback ID:' + callback_id);\n            return;\n          }\n          window.__cleanup(callback_id);\n\n          promiseInfo.resolve(result);\n        }\n      },\n      _updateData(data) {\n        const lynxView = document.querySelector('lynx-view');\n        if (lynxView) {\n          try {\n            const parsedData = JSON.parse(data);\n            lynxView.updateData(parsedData.__params || {});\n          } catch(err) {\n            console.log('updateDataError:', err); \n          }\n        }\n      }\n    };\n \n    addEventListener('message', event => {\n      if (event.data.type !== '@annie/web/jsb_update_data') {\n        return;\n      }\n      const paramStr = event.data.data;\n      if (window.JSBridge && window.JSBridge._updateData) {\n        JSBridge._updateData(paramStr);\n      } else if (window.Native2JSBridge && window.Native2JSBridge._updateData) {\n        Native2JSBridge._updateData(paramStr);\n      }\n    });\n\n    </script><script type=\"module\" nonce=\"8L9jOGYhQjTzmT2Zzz0Ar\">\n      function processError(error, replacementPath, lineOffset) {\n        const ErrorConstructor = error.constructor;\n        const newError = new ErrorConstructor(error.message);\n\n        Object.getOwnPropertyNames(error).forEach(key => {\n          if (key !== 'stack') newError[key] = error[key];\n        });\n\n        if (typeof error.stack === 'string') {\n          // 修复：正确转义正则表达式\n          const blobRegex = /blob:(https?:\\/\\/[^:]+):(\\d+):(\\d+)/g;\n          \n          let processedStack = error.stack.replace(blobRegex, function(match, url, lineStr, columnStr) {\n            const lineNum = parseInt(lineStr, 10);\n            const columnNum = parseInt(columnStr, 10);\n            const adjustedLine = isNaN(lineNum) ? lineStr : Math.max(1, lineNum - lineOffset);\n            \n            return replacementPath + ':' + adjustedLine + ':' + columnNum;\n          });\n\n          newError.stack = processedStack;\n        }\n\n        return newError;\n      }\n\n      const initView = () => {\n          var globalProps = window.__globalprops;\n          document.body.innerHTML = '<lynx-view style=\"height:100%; width:100%;\"></lynx-view>';\n          const initData = {\"type\":30,\"min_webcast_sdk_version\":1670,\"short_touch_type\":2,\"priority\":2,\"short_touch_info\":{\"short_touch_url\":\"https://lf-webcast-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx/pages/game_point_box/template.js\",\"short_touch_fallback_url\":\"https://lf-webcast-sourcecdn-tos.bytegecko.com/obj/byte-gurd-source/webcast/mono/lynx/short_touch/h5/pages/predictor_box/index.html\",\"short_touch_url_pc\":\"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js\",\"container_type\":1,\"width\":36,\"height\":36,\"jump_schema\":\"\",\"show_animation\":1,\"animation_type\":4,\"sub_item_list\":[\"{\\\"count\\\":0, \\\"readyBoxNum\\\": 1}\"],\"accessible_name\":\"领取游戏积分\"}};\n          // 属性设置\n          const lynxView = document.querySelector('lynx-view');\n          if (lynxView) {\n          // 设置gourpId\n          if (1){\n              lynxView.lynxGroupId = 1;\n          }\n          lynxView.globalProps = window.__globalprops;\n          // 设置初始值\n          try {\n              lynxView.initData = initData;\n          } catch(err) { }\n          lynxView.width = '100%';\n          lynxView.height = '100%';\n          lynxView.onNativeModulesCall = window._onNativeModulesCall;\n          customElements.whenDefined('lynx-view').then(() => {\n              lynxView.onNativeModulesCall = window._onNativeModulesCall;\n          });\n  \n          // 错误上报 并匹配产物sourceMap 获取到实际的产物地址\n          lynxView.addEventListener('error', (e) => {\n              if (false) {\n                  console.error('Lynx View Error:', e.detail);\n              } else {\n                  lynxView.setAttribute('style', 'display:none');\n                  lynxView.innerHTML = '';\n                  window.JS2NativeBridge._invokeError('lynxView error');\n              }\n              if (e.detail && e.detail.fileName === 'app-service.js') {\n                const error = e.detail.error;\n                const processedError = processError(error, \"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js\", 2);\n                window.__AnniexWebSlardar('captureException', processedError);\n              }\n          });\n          lynxView.url = \"https://lf-dy-gr-sourcecdn.bytegecko.com/obj/byte-gurd-source-gr/webcast/mono/lynx/gamecp_shorttouch_lynx_pc/pages/game_point_box/template.js?room_id=7682955227602897679&user_id=2685448719442378&sec_user_id=MS4wLjABAAAAbF6zRK529W2fLEga2jvy9mKmhYtTtQJRH30bQr43QQp3h-FnZ9LMENVyLEQTa4Ew&anchor_id=60241003767&anchor_id_str=60241003767&sec_anchor_id=MS4wLjABAAAAigD3FYb1hZWuz_rrD1V25V2hlpCkO3NtT7GDMJlwvkI&enter_from_merge=web_live&video_id=undefined&is_ad=0&request_id=undefined&enter_method=web_banner&user_unique_id=7682259617964197414&user_agent=Mozilla%2F5.0+%28Windows+NT+10.0%3B+Win64%3B+x64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F152.0.0.0+Safari%2F537.36+Edg%2F152.0.0.0&action_type=click&pc_client_type=1&pc_client_version=&device_platform=iphone&app_id=6383&app_version=18.9.0&gecko_bkt=7\";\n        }\n      };\n\n      if (customElements.get('lynx-view')) {\n        initView();\n      } else {\n        customElements.whenDefined('lynx-view').then(() => {\n          initView();\n        });\n      }\n    </script></head>\n\n<body style=\"width: 100%; height: 100%; margin: 0px 0px; padding: 0px;\">\n    <div id=\"root\"></div>\n\n\n</body></html>" }},
  ...
  scrollHeight: {get(){ v_console_log("  [*] Element -> scrollHeight[get]", 439);return 439 }},
...
Object.defineProperties(DocumentFragment.prototype, {
  firstElementChild: {get(){ v_console_log("  [*] DocumentFragment -> firstElementChild[get]", {});return {} }},
...
Object.defineProperties(AudioContext.prototype, {
  ...
  createMediaStreamDestination: {value: v_saf(function createMediaStreamDestination(){v_console_log("  [*] AudioContext -> createMediaStreamDestination[func]", [].slice.call(arguments));})},
...
Object.defineProperties(MediaStreamTrackGenerator.prototype, {
  writable: {get(){ v_console_log("  [*] MediaStreamTrackGenerator -> writable[get]", {});return {} }},
...
Object.defineProperties(MediaStreamAudioDestinationNode.prototype, {
  stream: {get(){ v_console_log("  [*] MediaStreamAudioDestinationNode -> stream[get]", {});return {} }},
  [Symbol.toStringTag]: {value:"MediaStreamAudioDestinationNode",writable:false,enumerable:false,configurable:true},
})
...
Object.defineProperties(AudioWorkletNode.prototype, {
  port: {get(){ v_console_log("  [*] AudioWorkletNode -> port[get]", {});return {} }},
  onprocessorerror: {set(){ v_console_log("  [*] AudioWorkletNode -> onprocessorerror[set]", [].slice.call(arguments));return {} }},
  [Symbol.toStringTag]: {value:"AudioWorkletNode",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(PerformanceNavigationTiming.prototype, {
  domComplete: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domComplete[get]", 1377.2000000476837);return 1377.2000000476837 }},
  loadEventStart: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> loadEventStart[get]", 1377.300000011921);return 1377.300000011921 }},
  loadEventEnd: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> loadEventEnd[get]", 1377.5);return 1377.5 }},
  type: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> type[get]", "navigate");return "navigate" }},
  domContentLoadedEventEnd: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventEnd[get]", 1190.7000000476837);return 1190.7000000476837 }},
  domContentLoadedEventStart: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventStart[get]", 1190.6000000238419);return 1190.6000000238419 }},
  domInteractive: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domInteractive[get]", 1139.6000000238419);return 1139.6000000238419 }},
...
Object.defineProperties(AnalyserNode.prototype, {
  frequencyBinCount: {get(){ v_console_log("  [*] AnalyserNode -> frequencyBinCount[get]", 1024);return 1024 }},
  fftSize: {get(){ v_console_log("  [*] AnalyserNode -> fftSize[get]", 2048);return 2048 }},
  getFloatFrequencyData: {value: v_saf(function getFloatFrequencyData(){v_console_log("  [*] AnalyserNode -> getFloatFrequencyData[func]", [].slice.call(arguments));})},
  getFloatTimeDomainData: {value: v_saf(function getFloatTimeDomainData(){v_console_log("  [*] AnalyserNode -> getFloatTimeDomainData[func]", [].slice.call(arguments));})},
  [Symbol.toStringTag]: {value:"AnalyserNode",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(HTMLElement.prototype, {
  nonce: {get(){ v_console_log("  [*] HTMLElement -> nonce[get]", "8L9jOGYhQjTzmT2Zzz0Ar");return "8L9jOGYhQjTzmT2Zzz0Ar" },set(){ v_console_log("  [*] HTMLElement -> nonce[set]", [].slice.call(arguments));return "8L9jOGYhQjTzmT2Zzz0Ar" }},
  ...
  tabIndex: {set(){ v_console_log("  [*] HTMLElement -> tabIndex[set]", [].slice.call(arguments));return {} }},
  ...
  innerText: {get(){ v_console_log("  [*] HTMLElement -> innerText[get]", "标清\n124\n送\n为你闪耀\nx\n1\nanyway\n送\n为你闪耀\nx\n2");return "标清\n124\n送\n为你闪耀\nx\n1\nanyway\n送\n为你闪耀\nx\n2" },set(){ v_console_log("  [*] HTMLElement -> innerText[set]", [].slice.call(arguments));return "标清\n124\n送\n为你闪耀\nx\n1\nanyway\n送\n为你闪耀\nx\n2" }},
  ...
  offsetWidth: {get(){ v_console_log("  [*] HTMLElement -> offsetWidth[get]", 910);return 910 }},
...
Object.defineProperties(SVGElement.prototype, {
  onclick: {set(){ v_console_log("  [*] SVGElement -> onclick[set]", [].slice.call(arguments)); }},
...
Object.defineProperties(HTMLScriptElement.prototype, {
  ...
  src: {get(){ v_console_log("  [*] HTMLScriptElement -> src[get]", "https://lf-webcast-platform.bytetos.com/obj/webcast-platform-cdn/webcast/douyin_live/chunks/8533.b520a641.js");return "https://lf-webcast-platform.bytetos.com/obj/webcast-platform-cdn/webcast/douyin_live/chunks/8533.b520a641.js" },set(){ v_console_log("  [*] HTMLScriptElement -> src[set]", [].slice.call(arguments));return "https://lf-webcast-platform.bytetos.com/obj/webcast-platform-cdn/webcast/douyin_live/chunks/8533.b520a641.js" }},
  crossOrigin: {set(){ v_console_log("  [*] HTMLScriptElement -> crossOrigin[set]", [].slice.call(arguments));return "https://lf-webcast-platform.bytetos.com/obj/webcast-platform-cdn/webcast/douyin_live/chunks/8533.b520a641.js" }},
  type: {set(){ v_console_log("  [*] HTMLScriptElement -> type[set]", [].slice.call(arguments));return "https://lf-webcast-platform.bytetos.com/obj/webcast-platform-cdn/webcast/douyin_live/chunks/8533.b520a641.js" }},
...
Object.defineProperties(HTMLMediaElement.prototype, {
  srcObject: {get(){ v_console_log("  [*] HTMLMediaElement -> srcObject[get]", {});return {} },set(){ v_console_log("  [*] HTMLMediaElement -> srcObject[set]", [].slice.call(arguments));return {} }},
  volume: {get(){ v_console_log("  [*] HTMLMediaElement -> volume[get]", 0.905);return 0.905 },set(){ v_console_log("  [*] HTMLMediaElement -> volume[set]", [].slice.call(arguments));return 0.905 }},
  ...
  autoplay: {get(){ v_console_log("  [*] HTMLMediaElement -> autoplay[get]", true);return true },set(){ v_console_log("  [*] HTMLMediaElement -> autoplay[set]", [].slice.call(arguments));return true }},
  paused: {get(){ v_console_log("  [*] HTMLMediaElement -> paused[get]", false);return false }},
  crossOrigin: {set(){ v_console_log("  [*] HTMLMediaElement -> crossOrigin[set]", [].slice.call(arguments));return false }},
  src: {get(){ v_console_log("  [*] HTMLMediaElement -> src[get]", "");return "" }},
  error: {get(){ v_console_log("  [*] HTMLMediaElement -> error[get]", {});return {} }},
  currentTime: {get(){ v_console_log("  [*] HTMLMediaElement -> currentTime[get]", 8.62);return 8.62 }},
  buffered: {get(){ v_console_log("  [*] HTMLMediaElement -> buffered[get]", {});return {} }},
  duration: {get(){ v_console_log("  [*] HTMLMediaElement -> duration[get]", null);return null }},
  ...
  playbackRate: {get(){ v_console_log("  [*] HTMLMediaElement -> playbackRate[get]", 1);return 1 }},
  readyState: {get(){ v_console_log("  [*] HTMLMediaElement -> readyState[get]", 4);return 4 }},
  networkState: {get(){ v_console_log("  [*] HTMLMediaElement -> networkState[get]", 2);return 2 }},
  play: {value: v_saf(function play(){v_console_log("  [*] HTMLMediaElement -> play[func]", [].slice.call(arguments));})},
  loop: {get(){ v_console_log("  [*] HTMLMediaElement -> loop[get]", false);return false }},
  controls: {get(){ v_console_log("  [*] HTMLMediaElement -> controls[get]", false);return false }},
...
Object.defineProperties(HTMLImageElement.prototype, {
  ...
  width: {get(){ v_console_log("  [*] HTMLImageElement -> width[get]", 720);return 720 }},
  height: {get(){ v_console_log("  [*] HTMLImageElement -> height[get]", 720);return 720 }},
  crossOrigin: {set(){ v_console_log("  [*] HTMLImageElement -> crossOrigin[set]", [].slice.call(arguments));return 720 }},
  [Symbol.toStringTag]: {value:"HTMLImageElement",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(HTMLInputElement.prototype, {
  type: {get(){ v_console_log("  [*] HTMLInputElement -> type[get]", "checkbox");return "checkbox" },set(){ v_console_log("  [*] HTMLInputElement -> type[set]", [].slice.call(arguments));return "checkbox" }},
  ...
  defaultChecked: {set(){ v_console_log("  [*] HTMLInputElement -> defaultChecked[set]", [].slice.call(arguments));return false }},
  name: {set(){ v_console_log("  [*] HTMLInputElement -> name[set]", [].slice.call(arguments));return false }},
...
Object.defineProperties(HTMLBaseElement.prototype, {
  href: {set(){ v_console_log("  [*] HTMLBaseElement -> href[set]", [].slice.call(arguments)); }},
...
Object.defineProperties(HTMLVideoElement.prototype, {
  videoWidth: {get(){ v_console_log("  [*] HTMLVideoElement -> videoWidth[get]", 960);return 960 }},
  videoHeight: {get(){ v_console_log("  [*] HTMLVideoElement -> videoHeight[get]", 540);return 540 }},
  getVideoPlaybackQuality: {value: v_saf(function getVideoPlaybackQuality(){v_console_log("  [*] HTMLVideoElement -> getVideoPlaybackQuality[func]", [].slice.call(arguments));})},
  webkitDecodedFrameCount: {get(){ v_console_log("  [*] HTMLVideoElement -> webkitDecodedFrameCount[get]", 215);return 215 }},
  webkitDroppedFrameCount: {get(){ v_console_log("  [*] HTMLVideoElement -> webkitDroppedFrameCount[get]", 0);return 0 }},
...
// Node's crypto implementation needs the native Buffer object. Keep it in
// Node and only hide it when the shim is used in a browser-like runtime.
if (typeof Buffer != 'undefined' && typeof process == 'undefined'){ Buffer = undefined }
...
function _createElement(name){
  var htmlmap = {"HTMLElement":["abbr","address","article","aside","b","bdi","bdo","cite","code","dd","dfn","dt","em","figcaption","figure","footer","header","hgroup","i","kbd","main","mark","nav","noscript","rp","rt","ruby","s","samp","section","small","strong","sub","summary","sup","u","var","wbr"],"HTMLScriptElement":["script"],"HTMLTemplateElement":["template"],"HTMLCanvasElement":["canvas"],"HTMLMediaElement":[],"HTMLAnchorElement":["a"],"HTMLLinkElement":["link"],"HTMLImageElement":["img"],"HTMLInputElement":["input"],"HTMLStyleElement":["style"],"HTMLBaseElement":["base"],"HTMLIFrameElement":["iframe"],"HTMLVideoElement":["video"],"HTMLHeadElement":["head"],"HTMLBodyElement":["body"],"HTMLUnknownElement":[]}
...
init_cookie("<已脱敏：登录后从浏览器复制的完整 Cookie 串>")
v_hook_href(window.location, 'location', "https://live.douyin.com/6096197105?activity_name=&anchor_id=60241003767&banner_type=recommend&category_name=all&page_type=live_main_page&user_id=2685448719442378")
Location.prototype.toString = v_saf(function toString(){ return "https://live.douyin.com/6096197105?activity_name=&anchor_id=60241003767&banner_type=recommend&category_name=all&page_type=live_main_page&user_id=2685448719442378" })
...
function v_getele(name, func){
  if(name == "S:0" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "B:0" && func == "getElementById"){ return v_new(HTMLTemplateElement) }
  if(name == "S:2" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "B:2" && func == "getElementById"){ return v_new(HTMLTemplateElement) }
  if(name == "LIVE_SSR_DATA_ID" && func == "getElementById"){ return v_new(HTMLScriptElement) }
  if(name == ".douyin-player-controls-left" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == ".douyin-player-controls" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "video" && func == "querySelector"){ return v_new(HTMLVideoElement) }
  if(name == ".douyin-player-triple-video-canvas" && func == "querySelector"){ return v_new(HTMLCanvasElement) }
  if(name == "#script-layouts" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "#script-set-tea-config" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "S:1" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "B:1" && func == "getElementById"){ return v_new(HTMLTemplateElement) }
  if(name == "a11y-configs" && func == "getElementById"){ return v_new(HTMLScriptElement) }
  if(name == "root" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "island_fa058" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_da635" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_a4110" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_3e027" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == ".douyin-player-controls-right" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == ".douyin-player-volume" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == ".douyin-player-volume-slider" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "script[nonce]" && func == "querySelector"){ return v_new(HTMLScriptElement) }
  if(name == "meta[name=\"theme-color\"]" && func == "querySelector"){ return v_new(HTMLMetaElement) }
  if(name == "#TipsLayout" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "control-right" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "#_douyin_live_scroll_container_" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "script[src=\"https://lf-ucenter-web.yhgfb-cn-static.com/obj/passport-fe/ucenter_fe/@byted/uc-secure-tool-detect/latest/dist/index.umd.production.js\"]" && func == "querySelector"){ return v_new(HTMLScriptElement) }
  if(name == "#LeftBackgroundLayout" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "#ContainerBackgroundLayout" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "island_237ab" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_076c3" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_b69f5" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "[data-container-id=\"@annie/web_oi9hryhgpaa_0\"]" && func == "querySelector"){ return v_new(HTMLIFrameElement) }
  if(name == "image_disable" && func == "getElementById"){ return v_new(HTMLImageElement) }
  if(name == "[data-id=\"pace-perf-timing\"]" && func == "querySelector"){ return v_new(HTMLScriptElement) }
  if(name == "[data-container-id=\"@annie/web_g7gfxqeiu7k_1\"]" && func == "querySelector"){ return v_new(HTMLIFrameElement) }
  if(name == "font-fingerprint" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "btn-feelgood" && func == "getElementById"){ return v_new(HTMLDivElement) }
  return null
}
function v_geteles(name, func){
  if(name == "head" && func == "getElementsByTagName"){ return [v_new(HTMLHeadElement)] }
  if(name == "script" && func == "querySelectorAll"){ return [v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement)] }
  if(name == "deferred-script" && func == "querySelectorAll"){ return [v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLElement)] }
  if(name == "link" && func == "getElementsByTagName"){ return [v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement)] }
  ...
  if(name == "style" && func == "getElementsByTagName"){ return [v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement)] }
  if(name == "link[data-rh]" && func == "querySelectorAll"){ return [v_new(HTMLLinkElement),v_new(HTMLLinkElement)] }
  if(name == "meta[data-rh]" && func == "querySelectorAll"){ return [v_new(HTMLMetaElement),v_new(HTMLMetaElement),v_new(HTMLMetaElement)] }
  if(name == "[rel=preload]" && func == "querySelectorAll"){ return [v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement)] }
  if(name == "[data-container-id^=\"@annie/web\"]" && func == "querySelectorAll"){ return [v_new(HTMLIFrameElement),v_new(HTMLIFrameElement)] }
  if(name == ".pixel-emoji" && func == "querySelectorAll"){ return [v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement)] }
  return null
}
var v_Date = Date;
